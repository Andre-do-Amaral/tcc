...
O fornecimento de água, é um dos serviços mais essenciais a vida humana, seja para abastecer as residências, ou também, serviços públicos, indústrias, usinas hidrelétricas para geração de energia, produção agrícola e agropecuária, e todo tipo de serviço que depende desse recurso natural valioso para a qualidade de vida, a economia e o meio ambiente. Fazer uma gestão eficiente da utilização dos recursos hídricos é primordial para garantir que todos esses setores continuem funcionando de forma sustentável, e é também uma questão de saúde pública, já que de acordo com informações do ministério da saúde, cenários de seca contribuem para desnutrição por afetar a produção agrícola, desidratação pela baixa disponibilidade de água e transmissão de doenças em cenários que seja necessário acionar fontes de água não devidamente tratadas devido a baixa disponibilidade do sistema de abastecimento.

De acordo com a \cite{ANA_Cantareira}, o Sistema Cantareira, é o maior produtor de água da Região Metropolitana de São Paulo (RMSP), sendo responsável por abastecer cerca de 46\% da população da RMSP. A gestão desse sistema é de responsabilidade da Agência Nacional de Águas (ANA) e do Departamento de Águas e Energia Elétrica do Estado de São Paulo (DAEE), já a operação do sistema é feita pela Companhia de Saneamento Básico de São Paulo (SABESP), sendo esta a responsável por observar e notificar a necessidade de operações emergenciais em casos excepcionais. 

Parte da gestão do Sistema Cantareira (SC), feito pela SABESP, consiste na coleta de dados como: volumes, vazões e precipitação, que auxiliam no acompanhamento da situação dos reservatórios, mananciais, adutores, estações e todos as equipamentos que constituem o sistema, de modo a registrar o comportamento dessas variáveis ao longo do tempo, e auxiliar na tomada de decisão sobre ações de racionalização e restrição no abastecimento de água, quando o reservatório atinge níveis alarmantes. De acordo com \cite{cemaden_cantareira_2025}, o volume útil do reservatório, ou seja, o volume que é utilizado para fornecimento de água, está em situação de alerta quando está entre 30\% e 40\% e entra em estado de restrição quando o volume se encontra entre 20\% e 30\%. 

Analisar o comportamento de varáveis como o volume útil dos reservatórios do Sistema Cantareira, nada mais é, do que de analisar uma série temporal de uma variável, que de acordo com \cite{Nielsen}, trata-se da extração de informações e estatísticas de dados organizados em ordem cronológica, com o objetivo de diagnosticar comportamentos passados e predizer o comportamento futuro da variável analisada. A capacidade de antever a ocorrência de períodos em que o volume útil atinja níveis preocupantes, e tomar ações antecipadas de racionalização no fornecimento de água, pode evitar principalmente que se atinja cenários críticos, tais quais, caracterizem um período de seca ou crise hídrica, como o registrado em 2014 e 2015, onde ocorreu o menor volume armazenado conhecido do SC. Conforme dados da SABESP, em tal crise, o volume útil ficou abaixo de 0\%, o que significa que foi necessário acionar o volume morto do reservatório, cenário extremo, que não se repetiu desde então. 

Diante da importância da gestão de fornecimento de água, nos diversos aspectos citados acima, o presente trabalho, tem como principal objetivo, criar um sistema capaz de dar suporte a tomada de decisão sobre o abastecimento de água, através da capacidade de visualizar cenários críticos antecipadamente. Para isso, pretende-se construir uma arquitetura que seja capaz de coletar e tratar os dados atualizados pela SABESP diariamente, treinar um modelo de machine learning para realizar previsões num horizonte determinado, e entregar uma visualização do cenário futuro previsto para o comportamento da disponibilidade de água no sistema. 
