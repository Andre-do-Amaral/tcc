...
\begin{folhadeaprovacao}
	...
	Este Trabalho de Conclusão de Curso foi julgado adequado para obtenção do Título de ``\imprimirformacao'' e aprovado em sua forma final pelo Curso Pós-Graduação Lato Sensu MBA em Machine Learning in Production.\\
	\vspace{12pt}
	...
	\vspace{6pt}
	Instituição: F1SRT Digital Services/ITI UFSCar\\
