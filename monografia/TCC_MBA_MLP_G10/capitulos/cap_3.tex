...
Apesar dos dados serem atualizados diariamente, devido a variação diária ser muito baixa no volume (pelo próprio conceito físico), optamos por fazer extrações semanais dos dados. A \autoref{tab:dados_cantareira} mostra o formato final dos dados que obtivemos.
